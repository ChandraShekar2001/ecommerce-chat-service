import { markManyMessagesAsRead, markMessageAsRead, updateOffer } from '@chat/utils/message.util';
import { IMessageDocument } from '@chandrashekar2001/ecommerce-shared';
